...
let ShowAllJourneys = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
...
}, _dec4 = Reflect.metadata("design:type", Function), _dec5 = Reflect.metadata("design:paramtypes", [typeof _IJourneyRepository.default === "undefined" ? Object : _IJourneyRepository.default, typeof _ICoursesRepository.default === "undefined" ? Object : _ICoursesRepository.default]), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = class ShowAllJourneys {
  ...
  async execute() {
    ...
    const filteredJourney = Promise.all(journeys.map(async j => {
      const course = await this.coursesRepository.findById(j.course_id);
