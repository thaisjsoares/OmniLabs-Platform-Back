...
let CreateRolesService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
...
}, _dec3 = Reflect.metadata("design:type", Function), _dec4 = Reflect.metadata("design:paramtypes", [typeof _IRolesRepository.default === "undefined" ? Object : _IRolesRepository.default]), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = class CreateRolesService {
  ...
  async execute({
    ...
    if (alreadyExistentRole) {
      throw new _AppError.default('This role already created', 400);
    }
